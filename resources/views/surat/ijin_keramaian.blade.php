...
<div class="isi">
    ...
    <p style="margin-top:6px;">Bermaksud menyelenggarakan kegiatan:</p>
    <table class="data" style="margin-top:6px;">
    ...
    <p style="margin-top:6px;">Tidak keberatan atas penyelenggaraan kegiatan tersebut dengan ketentuan tidak mengganggu ketertiban umum dan keamanan masyarakat.</p>
</div>
