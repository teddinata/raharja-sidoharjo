...
<div class="judul"><h3>Surat Pengantar Pembuatan KTP</h3><p>Nomor: {{ $surat->nomor_surat }}</p></div>
<div class="isi">
    <p>Yang bertanda tangan di bawah ini, Lurah {{ $setting->nama_kelurahan }}, dengan ini mengantarkan permohonan KTP atas nama:</p>
    ...
    <p style="margin-top:6px;">Mohon kiranya dapat diproses lebih lanjut ke Dinas Kependudukan dan Pencatatan Sipil Kabupaten {{ $setting->nama_kabupaten }}.</p>
</div>
