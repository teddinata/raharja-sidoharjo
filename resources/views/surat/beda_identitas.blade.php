...
<div class="isi">
    ...
    <p style="margin-top:6px;">Bahwa terdapat perbedaan <strong>{{ $extra['jenis_beda'] ?? '-' }}</strong> pada dokumen yang bersangkutan:</p>
    <table class="data" style="margin-top:6px;">
    ...
    <p style="margin-top:6px;">Bahwa kedua data tersebut adalah benar-benar milik orang yang sama.</p>
</div>
