...
<div class="isi">
    ...
    Provinsi {{ $setting->nama_provinsi }}, dengan ini menerangkan bahwa:</p>
    ...
    <table class="data" style="margin-top:12px;">
        ...
        <tr><td class="label">Alamat</td><td class="sep">:</td>
            ...
            Kabupaten {{ $setting->nama_kabupaten }}</td></tr>
    </table>

    <p style="margin-top:12px;">
        Adalah benar-benar warga dan berdomisili di Kalurahan {{ $setting->nama_kelurahan }},
        Kapanewon {{ $setting->nama_kapanewon }}, Kabupaten {{ $setting->nama_kabupaten }}.
    </p>
