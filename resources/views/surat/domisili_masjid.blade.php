...
<div class="isi">
    ...
    <p style="margin-top:6px;">Adalah benar-benar masjid/mushola yang berdomisili di wilayah Kalurahan {{ $setting->nama_kelurahan }}, Kapanewon {{ $setting->nama_kapanewon }}, Kabupaten {{ $setting->nama_kabupaten }}.</p>
</div>
