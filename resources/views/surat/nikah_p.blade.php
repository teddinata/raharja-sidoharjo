...
<div class="isi">
    ...
    <p style="margin-top:6px;"><strong>CALON ISTRI</strong></p>
    ...
    <p style="margin-top:8px;"><strong>CALON SUAMI</strong></p>
    <table class="data" style="line-height:1.2;">
    ...
    @if(!empty($extra['tanggal_akad']))<p style="margin-top:8px;">Rencana akad nikah: <strong>{{ \Carbon\Carbon::parse($extra['tanggal_akad'])->translatedFormat('d F Y') }}</strong></p>@endif
    <p style="margin-top:8px;">Bahwa yang bersangkutan bermaksud melangsungkan perkawinan dan memohon surat pengantar ke KUA Kapanewon {{ $setting->nama_kapanewon }}.</p>
</div>
<div class="penutup" style="margin-top:6px;"><p>Demikian surat pengantar ini dibuat untuk dapat dipergunakan sebagaimana mestinya.</p></div>
