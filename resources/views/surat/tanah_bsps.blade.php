...
<div class="isi">
    ...
    <p style="margin-top:6px;">Memiliki tanah dengan keterangan:</p>
    <table class="data" style="margin-top:6px;">
    ...
    <p style="margin-top:6px;">Yang bersangkutan adalah peserta program Bantuan Stimulan Perumahan Swadaya (BSPS) di Kalurahan {{ $setting->nama_kelurahan }}.</p>
</div>
