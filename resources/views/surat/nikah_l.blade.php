...
<div class="judul">
    <h3>Surat Pengantar Perkawinan</h3>
...
<div class="isi">
    ...
    <table class="data">
        ...
        <tr><td class="label">Tempat / Tanggal Lahir</td><td class="sep">:</td>
            <td class="value">{{ $extra['tempat_lahir_istri'] ?? '-' }}, {{ isset($extra['tgl_lahir_istri']) ? \Carbon\Carbon::parse($extra['tgl_lahir_istri'])->translatedFormat('d F Y') : '-' }}</td></tr>
        <tr><td class="label">Pekerjaan</td><td class="sep">:</td><td class="value">{{ $extra['pekerjaan_istri'] ?? '-' }}</td></tr>
        <tr><td class="label">Alamat</td><td class="sep">:</td><td class="value">{{ $extra['alamat_istri'] ?? '-' }}</td></tr>
    </table>
